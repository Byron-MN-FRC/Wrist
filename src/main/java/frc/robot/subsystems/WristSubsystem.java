...
public boolean isWristHorizontal = true;
...
rotationZero = new DigitalInput(0);
 addChild("rotationZero", rotationZero);
    ...
    // Put methods for controlling this subsystemhere. Call these from Commands.
    public void rotateToVertical() {
        targetPosition = Constants.WristConstants.rotationVerticalAlligned;

        closedLoopController.setReference(Constants.WristConstants.rotationVerticalAlligned,
            ControlType.kMAXMotionPositionControl,
            ClosedLoopSlot.kSlot0);

        isWristHorizontal = false;
        
    }

    public void rotateToHorizontal() {
        targetPosition = Constants.WristConstants.rotationHorizontalAlligned;

        closedLoopController.setReference(Constants.WristConstants.rotationHorizontalAlligned,
            ControlType.kMAXMotionPositionControl,
            ClosedLoopSlot.kSlot0);
    ...
    public boolean atPosition() {
        return Math.abs(encoder.getPosition() - targetPosition) < 1.0/360.0; //degree tolerance
    }
